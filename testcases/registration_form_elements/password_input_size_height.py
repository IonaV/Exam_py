...
def get_password_input_height():
    ...
    with webdriver.Chrome(service=service, options=chrome_options) as driver:
        ...
        register_password_height = register_password.size["height"]

    return expected_height, register_password_height


if __name__ == '__main__':
    get_password_input_height()
