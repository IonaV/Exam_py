...
def get_register_buttons_width():
    home_page = Home_page()
    ...
    with webdriver.Chrome(service=service, options=chrome_options) as driver:
        ...
        register_buttons_create_width = register_buttons_create.size["width"]

    return expected_width, register_buttons_create_width


if __name__ == '__main__':
    get_register_buttons_width()
